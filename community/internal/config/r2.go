...
type R2Config struct {
	...
	Bucket          string
	Prefix          string // Optional folder prefix within the bucket (e.g., "braccet" or "braccet/icons")
	PublicURL       string // Public URL for serving files (e.g., https://your-domain.com or R2 public bucket URL)
}
